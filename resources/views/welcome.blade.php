...
<!-- Mirrored from www.ansonika.com/atena/horizontal_nav/tour.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Aug 2023 07:53:50 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Uncomment to change color scheme <link href="websassets/css/tour-green.css" rel="stylesheet"> -->
    <!-- Uncomment to change color scheme <link href="websassets/css/tour-purple.css" rel="stylesheet"> -->
    <!-- Uncomment to change color scheme <link href="websassets/css/tour-red.css" rel="stylesheet"> -->
...
<!-- Common scripts -->
<script src="{{asset('websassets/js/jquery-1.11.2.min.js')}}"></script>
<script src="{{asset('websassets/js/functions.js')}}"></script>

<!-- Specific scripts -->
<script src="{{asset('websassets/js/tour.min.js')}}"></script>
