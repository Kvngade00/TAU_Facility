...
<meta charset="utf-8">
    ...
    <title>Female Hostel - {{ env('APP_NAME') }}</title>
    ...
    <!-- BASE CSS -->
    <link href="{{asset('tourassets/css/main_font/main_font.css')}}" rel="stylesheet">
    <link href="{{asset('tourassets/css/animate.min.css')}}" rel="stylesheet">
    <link href="{{asset('tourassets/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('tourassets/css/menu.css')}}" rel="stylesheet">
    <link href="{{asset('tourassets/css/style.css')}}" rel="stylesheet">
    <link href="{{asset('tourassets/css/responsive.css')}}" rel="stylesheet">
    <link href="{{asset('tourassets/css/elegant_font/elegant_font.min.css')}}" rel="stylesheet">
    <link href="{{asset('tourassets/css/icon_font/pe-icon-7-stroke.min.css')}}" rel="stylesheet">
    <link href="{{asset('tourassets/css/fontello/css/fontello.min.css')}}" rel="stylesheet">
    <link href="{{asset('tourassets/css/edu_fonts/edu_fonts.min.css')}}" rel="stylesheet">
    <link href="{{asset('tourassets/css/magnific-popup.css')}}" rel="stylesheet">

    <!-- YOUR CUSTOM CSS -->
    <link href="{{asset('tourassets/css/custom.css')}}" rel="stylesheet">
    
    <!-- SPECIFIC CSS -->
    <link href="{{asset('tourassets/css/tour.css')}}" rel="stylesheet">
    ...
    <!-- Modernizr -->
	<script src="{{asset('tourassets/js/modernizr_tour.js')}}"></script> 
</head>
...
<section class="tour-section">
		<div class="full-container">
			<h1 id="intro_txt">Welcome to ATENA<span>High level College and University campus</span></h1>
		</div>
    ...
    <nav>
		<ul class="top-nav">
			<li><a href="{{ url('/hostel') }}" class="back"><i class="arrow_back"></i></a></li>
		</ul>
	</nav> <!-- End top-nav-->

<!-- Common scripts -->
<script src="{{asset('tourassets/js/jquery-1.11.2.min.js')}}"></script>
<script src="{{asset('tourassets/js/functions.js')}}"></script>

<!-- Specific scripts -->
<script src="{{asset('tourassets/js/tour.min.js')}}"></script>
